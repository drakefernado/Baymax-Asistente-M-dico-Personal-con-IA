...
Baymax es un asistente de voz con inteligencia artificial inspirado en el personaje de Big Hero 6. Escucha tu voz, entiende lo que dices, genera una respuesta empática con Google Gemini y te la habla en voz alta usando ElevenLabs. Corre sobre **Arduino App Lab 0.7**.
